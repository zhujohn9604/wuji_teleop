...
class PosRotVecTrajectoryInterpolator:
    """
    pos rotvec
    """
    ...
    def trim(self,
            ...
            ) -> "PosRotVecTrajectoryInterpolator":
        ...
        return PosRotVecTrajectoryInterpolator(times=all_times, poses=all_poses)
    ...
    def drive_to_waypoint(self,
        ...
        final_interp = PosRotVecTrajectoryInterpolator(times, poses)
        return final_interp
